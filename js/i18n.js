...
const I18N = {
  pt: {
    ...
    leaderboardTitle: 'MELHOR RESULTADO NESTA DIFICULDADE',
    bestTime: 'Melhor tempo',
    bestMoves: 'Menos jogadas',
    newRecordTime: '🏆 Novo recorde de tempo',
    newRecordMoves: '🏆 Novo recorde de jogadas',
  ...
  en: {
    ...
    leaderboardTitle: 'BEST RESULT ON THIS DIFFICULTY',
    bestTime: 'Best time',
    bestMoves: 'Fewest moves',
    newRecordTime: '🏆 New time record',
    newRecordMoves: '🏆 New moves record',
